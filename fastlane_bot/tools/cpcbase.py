"""
base class for representing a generic curve in the context of the optimizer (1)

NOTE 1: whilst the name of the file ("cpc") alludes to constant product curves, this is for 
